    ...
    public void forAllEjbRefs(String template, Properties attributes) throws XDocletException
    {
        ...
        do {
            ...
            for (Iterator i = tags.iterator(); i.hasNext(); ) {
                ...
                XClass refedEJBClass = findEjb(tag.getAttributeValue("ejb-name"));
                ...
                if (!already.containsKey(refName)) {
                    ...
                    if (previousTag.getAttributeValue("ejb-name") != tag.getAttributeValue("ejb-name") || previousTag.getAttributeValue("jndi-name") != tag.getAttributeValue("jndi-name")) {
