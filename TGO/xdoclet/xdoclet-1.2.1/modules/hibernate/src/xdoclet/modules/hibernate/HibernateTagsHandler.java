     ...
     extends XDocletTagSupport
{
     ...
     * @param template
     * @param attributes
     * @hibernate.component,     as there may be more than one component in a class that refer to the same target class.
     * @throws XDocletException
     */
    public void setColumnPrefix(String template, Properties attributes)
         throws XDocletException
    {
        columnPrefix = attributes.getProperty("prefix", "");
        generate(template);
        columnPrefix = "";
    }
    ...
    public String computeColumnName(Properties attributes)
    {
        ...
        if (!(null == columnPrefix || columnPrefix.length() == 0)) {
